...
public class MainFrame extends JFrame implements Printable {
        ...
        previewButton.addActionListener(new ActionListener() {
            public void actionPerformed(final ActionEvent e) {
                ...
                if (imgFile != null) {
                    ...
                    JOptionPane.showMessageDialog(null, "請先選擇要列印預覽的圖片！");
                }
            }
        });
    ...
    public void printPicture(Graphics graphics, PageFormat pageFormat,
        ...
        if (imgFile != null && isPreview) {
            ...
            int mw = (int) pf.getWidth() - x * 2;// 紙張寬度減去左右邊緣
            int mh = (int) pf.getHeight() - y * 2;// 紙張高度減去上下邊緣
            if (imgWidth > mw) { // 如果圖形的寬度大於可列印區域
                imgWidth = mw;
            }
            if (imgHeight > mh) { // 如果圖形的高度大於可列印區域
                imgHeight = mh;
            }
