...
public class PrintPieReportFrame extends JFrame implements Printable {
    ...
    public PrintPieReportFrame() {
        super();
        PieDataset dataset = createDataset();// 建立資料集對像
        JFreeChart chart = createChart(dataset);// 建立圖表對像
        String path = System.getProperty("user.dir")
                + "/src/chartImg/chart.jpg";// 圖表的儲存位置
        try {
    ...
    class PreviewCanvas extends Canvas {
        public void paint(Graphics g) {
            try {
                ...
                PrintPieReportFrame.this.print(g, pf, 0);// 呼叫print()方法
    ...
    public void printPicture(Graphics graphics, PageFormat pageFormat,
        ...
        if (rs != null && isPreview) {
            ...
            try {
                ...
                /********************* 繪製圖表圖片 *****************************/
                URL imgUrl = PrintPieReportFrame.class.getResource("/chartImg/chart.jpg");// 獲得圖片資源的路徑
